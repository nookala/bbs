...
func (fake *FakeClient) ActualLRPsByProcessGuids(arg1 lager.Logger, arg2 string, arg3 models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error) {
...
func (fake *FakeClient) ActualLRPsByProcessGuidsCalls(stub func(lager.Logger, string, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = stub
}

func (fake *FakeClient) ActualLRPsByProcessGuidsArgsForCall(i int) (lager.Logger, string, models.ActualLRPsByProcessGuidsFilter) {
	fake.actualLRPsByProcessGuidsMutex.RLock()
	defer fake.actualLRPsByProcessGuidsMutex.RUnlock()
