...
type FakeInternalClient struct {
	...
	ActualLRPsByProcessGuidsStub        func(lager.Logger, string, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)
	actualLRPsByProcessGuidsMutex       sync.RWMutex
	actualLRPsByProcessGuidsArgsForCall []struct {
		arg1 lager.Logger
		arg2 string
		arg3 models.ActualLRPsByProcessGuidsFilter
	}
...
func (fake *FakeInternalClient) ActualLRPsByProcessGuids(arg1 lager.Logger, arg2 string, arg3 models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error) {
	...
	fake.recordInvocation("ActualLRPsByProcessGuids", []interface{}{arg1, arg2, arg3})
...
func (fake *FakeInternalClient) ActualLRPsByProcessGuidsCalls(stub func(lager.Logger, string, models.ActualLRPsByProcessGuidsFilter) ([]*models.ActualLRP, error)) {
	fake.actualLRPsByProcessGuidsMutex.Lock()
	defer fake.actualLRPsByProcessGuidsMutex.Unlock()
	fake.ActualLRPsByProcessGuidsStub = stub
}

func (fake *FakeInternalClient) ActualLRPsByProcessGuidsArgsForCall(i int) (lager.Logger, string, models.ActualLRPsByProcessGuidsFilter) {
	fake.actualLRPsByProcessGuidsMutex.RLock()
	defer fake.actualLRPsByProcessGuidsMutex.RUnlock()
